...
export const text = {
  HOME_TITLE: "Kênh thông tin bất động sản cho thuê hàng đầu",
  HOME_DESCRIPTION:
    "Nền tảng uy tín, chuyên cung cấp dịch vụ đăng tin cho thuê phòng trọ, nhà nguyên căn, căn hộ, và tìm kiếm bạn ở ghép. Với hơn 100.000 tin đăng và hơn 2.500.000 lượt truy cập mỗi tháng, chúng tôi tự hào là cầu nối hiệu quả giữa chủ nhà và người thuê. Dễ dàng tìm kiếm, nhanh chóng kết nối, đảm bảo tin cậy.",
};
